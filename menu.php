...
<div class="row">
    <form>
        ...
        <div class="col-md-2">
            ...
            <button class="btn btn-success add_submit" type="button" style="margin-top:230px;margin-left:18px;">添加
            </button>
            <button class="btn btn-danger delete_submit" type="button" style="margin-top:310px;margin-left:18px;">删除
            </button>
